  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] gap-6 max-md:grid-cols-[auto_1fr_1fr]">
          <div className="md:grid w-full grid grid-cols-1 grid-rows-4 gap-6 items-center text-end max-md:order-2">
          ...
          <div className="w-0.5 md:w-0.5 grid grid-cols-1 grid-rows-4 border border-blue-400 items-center max-md:order-1">
          ...
          <div className="grid grid-cols-1 grid-rows-4 gap-6 items-center max-md:order-3">
            <span className="w-[60%] mx-auto">
