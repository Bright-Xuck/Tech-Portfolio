...
export default function App() {
  ...
  function addToRefs(el) {
    if (el && !refer.current.includes(el)) {
      refer.current.push(el);
    }
  }
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        console.log(entries);
        entries.forEach(
          (each) => each.isIntersecting && each.target.classList.toggle("fade-in")
        );
      },
      { threshold: 0.2 },
    );
  ...
  return (
    <Router>
      <main className="overflow-hidden max-w-screen">
            ...
            <section className="hero-section h-screen flex flex-col justify-center items-center z-10 text-white relative">
              ...
              <div className="fixed bottom-8 animate-bounce flex flex-col items-center gap-2 z-20">
                ...
                <div className="border-2 border-white/40 rounded-full p-2 w-7 h-7 grid relative justify-center items-center hover:border-white/70 transition-colors duration-300 animate-bounce">
                  <ArrowDown
                    size={24}
                    className="text-white/60 animate-bounce absolute"
                  />
                </div>
              </div>
            </section>
        ...
        >
          <div className="mx-auto" id="about" ref={addToRefs}>
            <ImageSlider />
            <h3>
        ...
        <section id="work" className="" ref={addToRefs}>
          <Projects />
        </section>
        ...
        <section
          id="contact"
          className="w-full px-4 sm:px-8 py-16 sm:py-20 bg-black/80 backdrop-blur-sm"
        >
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 sm:p-6 rounded-lg bg-linear-to-br from-blue-900/40 to-purple-900/40 border border-blue-500/30 hover:border-blue-400/60 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:brightnjikang@gmail.com"
                      className="text-blue-300 hover:text-blue-200 transition-colors break-all text-sm sm:text-base"
                    >
                ...
                <div className="flex items-start gap-4 p-4 sm:p-6 rounded-lg bg-linear-to-br from-purple-900/40 to-blue-900/40 border border-purple-500/30 hover:border-purple-400/60 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
                  ...
                  <div>
                    ...
                    <a
                      href="https://linkedin.com/in/brightnjikang"
                ...
                <div className="flex items-start gap-4 p-4 sm:p-6 rounded-lg bg-linear-to-br from-lime-900/40 to-green-900/40 border border-lime-500/30 hover:border-lime-400/60 transition-all duration-300 hover:shadow-lg hover:shadow-lime-500/20">
                  ...
                  <div>
                    ...
                    <a
                      href="https://github.com/bright-Xuck"
                      className="text-lime-300 hover:text-lime-200 transition-colors text-sm sm:text-base"
                    >
                      bright-Xuck
                    </a>
                  </div>
              ...
              <form
                action=""
                method="POST"
                className="space-y-6 p-4 sm:p-8 rounded-lg bg-linear-to-br from-blue-900/30 to-purple-900/30 border border-purple-500/30 backdrop-blur-sm"
              >
